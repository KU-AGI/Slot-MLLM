...
class Blip2QformerQuantizer(Blip2Base):
    ...
    def __init__(self,
        ...
        self.Qformer.cls.predictions.bias = nn.Parameter(torch.zeros(len(self.tokenizer)))
        self.Qformer.cls.predictions.decoder.bias = nn.Parameter(torch.zeros(len(self.tokenizer)))
